...
use app\models\Menuusuarioadminsearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * MenuusuarioadminController implements the CRUD actions for Menuusuario model.
 */
class MenuusuarioadminController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new Menuusuarioadminsearch();
