...
/**
 * PlanillaSearch represents the model behind the search form about `app\models\Planilla`.
 */
class PlanillaSearch extends Planilla
{
    ...
    public function rules()
    {
        return [
            ...
            [['MesPlanilla', 'AnioPlanilla', 'FechaTransaccion', 'DiasIncapacidad', 'DiasPermiso'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'MesPlanilla', $this->MesPlanilla])
            ...
            ->andFilterWhere(['like', 'DiasPermiso', $this->DiasPermiso]);
