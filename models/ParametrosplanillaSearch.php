...
/**
 * ParametrosplanillaSearch represents the model behind the search form about `app\models\Parametrosplanilla`.
 */
class ParametrosplanillaSearch extends Parametrosplanilla
{
    ...
    public function rules()
    {
        return [
            ...
            [['FechaCreacion', 'MesPlanilla', 'PeriodoPlanilla', 'QuincenaPlanilla'], 'safe'],
        ];
    }
