...
class DepartamentosSearch extends Departamentos
{
    ...
    {
        return [
            [['IdDepartamentos', 'NombreDepartamento'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'IdDepartamentos', $this->IdDepartamentos])
            ->andFilterWhere(['like', 'NombreDepartamento', $this->NombreDepartamento]);
