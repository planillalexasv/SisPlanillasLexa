...
/**
 * ConstancianodependienteSearch represents the model behind the search form about `app\models\Empleado`.
 */
class ConstancianodependienteSearch extends Empleado
{
    /**
     * @inheritdoc
     */
