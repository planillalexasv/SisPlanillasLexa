                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <h4 class="card-title">Ingreso de Parametros para Carta de Renuncia</h4>
                                      ...
                                      <select name="Empleado" class="form-control">
                                          ...
                                          <?php
                                              while($row = $resultadoqueryempleado->fetch_assoc()){
                                                  echo "<option name='IdEmpleado' value='".$row['IdEmpleado']."'>".$row['NombreCompleto']."</option>";
                                              }
                                          ?>
                                      </select>
                                     </div>
                                     <div class="form-group col-md-4">
                                          <label for="title">Fecha de Reununcia</label>
                                          <input name="Fecharenuncia" type="text" class="form-control datepicker"/>
                                      </div>
                                    </div>
                                    <div class="row">
                                       <div class="form-group col-md-4">
                                         <center>
                                         <button type="submit" class="btn btn-success" name="guardarPlanilla" >Generar Carta</button>
                                       </center>
                                        </div>
                                      </div>
                                      </form>
